#!/usr/bin/env python3
"""
Titanium Variations Renderer - 5 key variations
"""
...
OUTPUT_DIR = Path(__file__).parent.parent / "public" / "assets" / "materials" / "metal" / "titanium-variations"

TITANIUM_VARIATIONS = [
    {"id": "titanium-polished", "name": "Polished Titanium", "color": (0.75, 0.73, 0.70), "roughness": 0.1, "metalness": 1.0},
    {"id": "titanium-brushed", "name": "Brushed Titanium", "color": (0.65, 0.63, 0.60), "roughness": 0.35, "metalness": 1.0},
    {"id": "titanium-matte", "name": "Matte Titanium", "color": (0.55, 0.53, 0.50), "roughness": 0.55, "metalness": 1.0},
    {"id": "titanium-anodized-blue", "name": "Anodized Blue", "color": (0.25, 0.40, 0.70), "roughness": 0.2, "metalness": 0.9},
    {"id": "titanium-anodized-purple", "name": "Anodized Purple", "color": (0.50, 0.30, 0.60), "roughness": 0.2, "metalness": 0.9},
]
...
def create_material(variation):
    ...
    if principled:
        ...
        principled.inputs["IOR"].default_value = 2.16
    return mat
...
def main():
    print("\n" + "=" * 50)
    print("Titanium Variations Renderer")
    print("=" * 50)
    OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
    sphere = setup_scene()
    setup_render_settings()

    for i, v in enumerate(TITANIUM_VARIATIONS, 1):
        print(f"[{i}/{len(TITANIUM_VARIATIONS)}] {v['name']}")
