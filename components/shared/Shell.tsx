...
export function Shell({ 
  ...
  return (
    <div className={`flex flex-col h-screen bg-neutral-950 text-white overflow-hidden ${className}`}>
      ...
      <nav className="h-14 border-b border-neutral-800 flex items-center px-4 justify-between bg-neutral-900/50 backdrop-blur-sm z-50 shrink-0">
        ...
        <div className="flex items-center gap-4">
          {/* Right side global actions (User, Settings, etc.) can go here */}
      ...
      <main className="flex-1 relative overflow-hidden flex">
        ...
        {/* Right Panel Slot */}
        {rightPanel && (
          <div className="z-40 h-full relative pointer-events-none">
             <div className="pointer-events-auto h-full">
               {rightPanel}
             </div>
          </div>
