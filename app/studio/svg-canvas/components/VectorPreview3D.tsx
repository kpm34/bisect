...
interface VectorPreview3DProps {
  albedo?: string;
  normal?: string;
  roughness?: string;
  mode: TextureMode;
...
const TexturedMesh: React.FC<VectorPreview3DProps> = ({ albedo, normal, roughness, mode, geometryType }) => {
...
export const VectorPreview3D: React.FC<VectorPreview3DProps> = (props) => {
  return (
