  ...
  return (
    <div className="fixed bottom-0 left-0 w-full bg-zinc-900/90 backdrop-blur-md border-t border-zinc-800 px-6 py-3 flex justify-between items-center z-50">
      ...
      <div className="flex items-center gap-2">
        <div className="w-2 h-2 rounded-full bg-cta-orange"></div>
      ...
      <div className="flex items-center gap-4">
        ...
        <button 
          onClick={onDownload} 
          className="flex items-center gap-2 px-4 py-2 rounded-lg bg-cta-orange hover:bg-cta-orange-hover text-white transition-colors text-sm font-medium shadow-lg shadow-cta-orange/20"
        >
          <Download size={16} />
