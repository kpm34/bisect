...
const Toolbar: React.FC<ToolbarProps> = ({
  ...
  return (
    <div className="absolute left-4 top-1/2 -translate-y-1/2 bg-zinc-900/90 backdrop-blur-md border border-zinc-800 p-3 rounded-2xl shadow-2xl flex flex-col gap-4 w-16 items-center z-50">
